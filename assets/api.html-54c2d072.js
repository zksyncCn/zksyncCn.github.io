...
`),I,e("p",null,[n("zkSync与"),e("a",D,[n("Geth的pubsub API"),t(p)]),n("完全兼容，除了"),S,n("的订阅。这是因为zkSync网络上的节点在技术上总是同步的。")]),E,e("div",w,[C,e("p",null,[n("你可以使用websocket端点来处理智能合约事件，如"),t(a,{to:"/api/.../dev/building-on-zksync/events.html"},{default:s(()=>[n("本节文档")]),_:1}),n("所详述。")])])])}const R=c(l,[["render",j],["__file","api.html.vue"]]);export{R as default};
