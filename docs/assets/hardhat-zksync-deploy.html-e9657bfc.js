import{_ as i,W as l,X as p,Z as n,$ as s,a0 as a,a2 as r,Y as t,D as e}from"./framework-674379d2.js";const d={},u=t('<h1 id="hardhat-zksync-deploy" tabindex="-1"><a class="header-anchor" href="#hardhat-zksync-deploy" aria-hidden="true">#</a> <code>hardhat-zksync-deploy</code></h1><p>这个插件提供了在zkSync上部署智能合约的工具，这些智能合约是由<code>@matterlabs/hardhat-zksync-solc</code>或<code>@matterlabs/hardhat-zksync-vyper</code>插件构建的。</p><div class="hint-container warning"><p class="hint-container-title">Note</p><p>合同必须使用官方的<code>@matterlabs/hardhat-zksync-solc</code>或<code>@matterlabs/hardhat-zksync-vyper</code>插件进行编译。用其他编译器编译的合约将无法使用此插件部署到zkSync。</p></div><h2 id="installation" tabindex="-1"><a class="header-anchor" href="#installation" aria-hidden="true">#</a> Installation</h2>',4),k={href:"https://www.npmjs.com/package/@matterlabs/hardhat-zksync-deploy",target:"_blank",rel:"noopener noreferrer"},m=t(`<p>用以下命令将该插件的最新版本添加到你的项目中。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code># Yarn
